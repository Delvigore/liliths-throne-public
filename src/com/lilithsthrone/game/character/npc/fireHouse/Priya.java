...
public class Priya extends NPC {
	...
	public Priya(boolean isImported) {
		super(isImported, new NameTriplet("Priya"), "Cooper",
				"Priya is a firefighter stationed at the fancy firehouse"
						+ " She's friendly and likes long walks on the beach",
				24, Month.AUGUST, 11,
				15,
				Gender.F_V_B_FEMALE, Subspecies.DOG_MORPH_GERMAN_SHEPHERD, RaceStage.GREATER,
				new CharacterInventory(10), WorldType.DOMINION_FIREHOUSE, PlaceType.FIREHOUSE_STAGE_AREA, true);
		
		if(!isImported) {
			this.setPlayerKnowsName(false);
			this.setGenericName("German Sheperd Firefighter");
		}
	}
	...
	public void setStartingBody(boolean setPersona) {
		...
		this.setSkinCovering(new Covering(BodyCoveringType.CANINE_FUR, CoveringPattern.MARKED, CoveringModifier.FLUFFY, PresetColour.COVERING_BLACK, false, PresetColour.COVERING_TAN, false), true);
